...
#     inputperfix=StringField("输入：")
    ...
    software=SelectField('选择软件/工具',choices=[("bowtie2","bowtie2"),("java -Xmx40g -Djava.io.tmpdir=/lustre/home/liurui/tmp -jar /opt/picard-tools-2.5.0/picard.jar","SortSam"),("java -Xmx40g -Djava.io.tmpdir=/lustre/home/liurui/tmp -jar /opt/picard-tools-2.5.0/picard.jar","MarkDuplicates"),("java -Xmx40g -Djava.io.tmpdir=/lustre/home/liurui/tmp  -jar /opt/GenomeAnalysisTK-3.8-0-ge9d806836/GenomeAnalysisTK.jar","GenomeAnalysisTK.jar"),("python ~/software/kosaidtu-norgal-d61342edcdfd/norgal.py","python ~/software/kosaidtu-norgal-d61342edcdfd/norgal.py"),("python ~/life/src/usci/depthDistance.py","python ~/life/src/usci/depthDistance.py")])
