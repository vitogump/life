...
parser.add_option("-P","--positive_withgenename",dest="multiple_positive_winfiles_withgenename",action="append",nargs=2,default=[],help="on top")#
parser.add_option("-N","--negtive_withgenename",dest="multiple_negtive_winfiles_withgenename",action="append",nargs=2,default=[],help="at bottom")#
...
if __name__ == '__main__':
    ...
    if (options.multiple_negtive_winfiles_withgenename!=[] or options.multiple_positive_winfiles_withgenename!=[]):
        makeMhtGraph.makeMhtplots_compareInOnePicture_withgeneName(options.pathoutputfilename, options.multiple_positive_winfiles_withgenename, options.multiple_negtive_winfiles_withgenename, 0)
    else:
