...
parser.add_option("-A","--anchorfile",dest="anchorfile",default=None,help="used to Z-transform in auto and sex separately, conflict with -S and affect parameter definition of -p/-n; file usemark or None")
