...
if __name__ == '__main__':
    ...
    if options.mode.strip()=="1":
        ...
        for currentchrID,currentchrLen in chrom_lenlist:
            ancestralalleletabletools.getflankseqs(currentchrID,currentchrLen, flanklen, currentchrLen, idxedreffilehandler=duckrefhandler,ancestralgenomename=colname, refindex=duckrefindex, flanklen=flanklen,outfile=outfile, tablename=toplevelsnptablename)
        outfile.close()
