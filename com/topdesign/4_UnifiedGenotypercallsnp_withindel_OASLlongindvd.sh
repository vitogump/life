...
cmdline=java -Xmx40g -Djava.io.tmpdir=/home/liurui/tmp  -jar $GATK_path/GenomeAnalysisTK.jar -T UnifiedGenotyper -R $duckbowtie2index -I ${1.bam} -glm BOTH -o ${output=/home/liurui/data/vcffiles/OASLref|suffix=withindel.vcf}
