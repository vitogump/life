...
cmdline=java -Xmx40g -Djava.io.tmpdir=/home/liurui/tmp  -jar $GATK_path/GenomeAnalysisTK.jar -T IndelRealigner -allowPotentiallyMisencodedQuals -R $duckbowtie2index -I ${sorted.dedup.uniqmapped.bam} -targetIntervals ${.realigner.intervals} -o ${output=/home/liurui/data/bamfiles/beijingduckref|suffix=sorted.dedup.realigned.0.3uniqmapped.bam}
