...
cmdline=java -Xmx40g -Djava.io.tmpdir=/home/liurui/tmp -jar $GATK_path/GenomeAnalysisTK.jar  -T RealignerTargetCreator -R $duckbowtie2index -I ${dedup.uniqmapped.bam} -o ${output=/home/liurui/data/bamfiles/beijingduckref|suffix=realigner.intervals}
