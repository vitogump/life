...
cmdline=java -Xmx40g -Djava.io.tmpdir=/home/liurui/tmp  -jar $GATK_path/GenomeAnalysisTK.jar -T UnifiedGenotyper -R $duckbowtie2index -I ${dedup.realigned.uniqmapped.bam} -glm BOTH -o ${output=/home/liurui/data/vcffiles/beijingref|suffix=withindel.vcf}
